...
public class TaskphotoVo {
	...
	public TaskphotoVo(String prjctno, String jobno, String jobnm, String jobcn, String jobpriort, String jobsttus,
			int prgsdo, String jobrgsde, String jobbgnde, String jobclosde, String upperjobno, String jobwrter,
			int mcount, String manager, String usid, String pROFLPHOTO) {
		super();
		this.prjctno = prjctno;
		this.jobno = jobno;
		this.jobnm = jobnm;
	...
	public String toString() {
		return "TaskphotoVo [prjctno=" + prjctno + ", jobno=" + jobno + ", jobnm=" + jobnm + ", jobcn=" + jobcn
				...
				+ ", PROFLPHOTO=" + PROFLPHOTO + ", getUsid()=" + getUsid() + ", getManager()=" + getManager()
				+ ", getMcount()=" + getMcount() + ", getPrjctno()=" + getPrjctno() + ", getJobno()=" + getJobno()
				+ ", getJobnm()=" + getJobnm() + ", getJobcn()=" + getJobcn() + ", getJobpriort()=" + getJobpriort()
				+ ", getJobsttus()=" + getJobsttus() + ", getPrgsdo()=" + getPrgsdo() + ", getJobrgsde()="
				+ getJobrgsde() + ", getJobbgnde()=" + getJobbgnde() + ", getJobclosde()=" + getJobclosde()
				+ ", getUpperjobno()=" + getUpperjobno() + ", getJobwrter()=" + getJobwrter() + ", getPROFLPHOTO()="
				+ getPROFLPHOTO() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()="
				+ super.toString() + "]";
	}
