...
public class TaskVo2 {
	...
	public String toString() {
		return "TaskVo2 [prjctno=" + prjctno + ", jobno=" + jobno + ", jobnm=" + jobnm + ", jobcn=" + jobcn
	...
	public TaskVo2(String prjctno, String jobno, String jobnm, String jobcn, String jobpriort, String jobsttus,
			int prgsdo, String jobrgsde, Date jobbgnde, Date jobclosde, String upperjobno, String jobwrter, int mcount, String prjctnm) {
