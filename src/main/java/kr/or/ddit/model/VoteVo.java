...
public class VoteVo {
	...
	private String votewrt;
	
	
	
	public String getVotewrt() {
		return votewrt;
	}

	public void setVotewrt(String votewrt) {
		this.votewrt = votewrt;
	}
	...
	public VoteVo(String realvoteno, String voteno, String prjctno, Date votede, String voteendde, String votethema,
			String usid, int voteone, String votelist, int votelistno, int clostt, int novote, String etcopinion,
			String votewrt) {
		super();
		this.realvoteno = realvoteno;
		this.voteno = voteno;
	...
	public String toString() {
		return "VoteVo [realvoteno=" + realvoteno + ", voteno=" + voteno + ", prjctno=" + prjctno + ", votede=" + votede
				...
				+ ", etcopinion=" + etcopinion + ", votewrt=" + votewrt + "]";
	}
