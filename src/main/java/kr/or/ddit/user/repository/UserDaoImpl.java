...
public class UserDaoImpl implements UserDao{
	...
	@Override
	public List<MemberVo> selectMemberPr(String prjctno) {
		return template.selectList("member.selectMemberPr", prjctno);
	}

	@Override
	public List<UsersVo> selectProfile(String prjctno) {
		return template.selectList("member.selectProfile", prjctno);
	}

	@Override
	public UsersVo selectPro(String usid) {
		return template.selectOne("member.selectPro", usid);
	}
