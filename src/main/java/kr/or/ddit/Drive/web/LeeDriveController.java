...
@Controller
public class  LeeDriveController{

	private static final Logger logger = LoggerFactory.getLogger(LeeDriveController.class);
	...
	public String fileList(DriveVo drivevo,Model model, HttpSession session) {
		String prjctno = (String)session.getAttribute("prjctno");
	...
	public String defile( DriveVo driveVo, HttpSession session) {
		String prjctno = (String)session.getAttribute("prjctno");
	...
	public String upfolder(String prjctno,DriveVo driveVo, Model model, HttpSession session) {
