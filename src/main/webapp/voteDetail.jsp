...
$("#voteDetailList").on("click",function(){
	...
	$.ajax({
		...
		success: function(data){
			...
			code+='<span style="margin-left:30px; margin-right: 10px;">'+v.votelist+'</span>        ';
			code+=' <br>                                                                               ';
			code+=' <br>                                                                               ';
			});
			$.each(data.votecontlist,function(i, v1){
				code+='<label style="font-weight: bold;">'+v1.novote +' </label>                      ';
				code+=' <br>                                                                               ';
			});
			$('.title').append(code);
		}
...
<body>
	...
	<div class="wrapper">
		...
		<section class="content">
			...
			<div class="title"style="margin-top:5%; margin-left: 5%;">
