...
$('#votecomplate').on('click', function(){
	
	var voteno =$("#voteno").text();
	
	$.ajax({
		
		url:"/vote/votecomplate",
		type:"get",
		dataType:"json",
		data : {"voteno":voteno},
		error : function(xhr) {
	...
	<%@ include file="/WEB-INF/views/common/header.jsp"%>
		...
		<div class="col-md-8" style="margin-left: 150px; margin-top: 50px; font-size: 17px;">
			...
			<div class="votebtn">
				...
				<c:choose>
				<c:when test="${votewrt.equals(usid2)}">
					<input type="button" id="votecomplate" value="투표종료" class="btn btn-light"  style="margin-left: 600px;">
				...
				<ul class="fix_info" style="margin-top:5%; ">
			...
			<c:choose>
				<c:when test="${voteclostt == 1}">
				<div class="resultview">
					투표가 종료되었습니다<br><br><br>
					<a href="#" id="voteresult">❓결과보러가기❓</a>
				</div>
				</c:when>
				
				<c:when test="${voteuser == null && voteclostt != 1}">
				...
				<c:otherwise>
					<div class="resultview">
						이미 투표를 하셨습니다<br><br><br> <a href="#" id="voteresult">❓결과보러가기❓</a>
					</div>
