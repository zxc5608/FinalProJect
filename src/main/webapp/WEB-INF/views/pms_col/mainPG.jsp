       ...
       <!-- <div class="row"> -->
         <div class="col-md-8" style="margin-left:10%;">
            ...
            <div class="post_write_tab">
               ...
               <div class="titleBx">
               <input type="text" name="jobnm" style="display: block; border: 0; width: 95%;font-size: 18px; line-height: 18px; font-family: inherit; background: none; font-weight: bolder;"  placeholder="업무명을 입력하세요">
               </div>
               <hr>
               <div class="workTab"> 
               <label> </label>
                  <div onclick="jobsttus(this.id)" id="요청" class="tab1 on" ><label>요청</label></div>
                  <div onclick="jobsttus(this.id)" id="진행" class="tab2" style="margin-left: -10px;"><label>진행</label></div>
                  <div onclick="jobsttus(this.id)" id="완료" class="tab3" style="margin-left: -10px;" ><label>완료</label></div>
                  <div onclick="jobsttus(this.id)" id="보류" class="tab4" style="margin-left: -10px;"><label>보류</label></div>
               </div>
...
<!--                   <div class="collapse" id="collapseExample"> -->
                     ...
                     <div class="workTab"> 
                        ...
                        <input type="text" id="person" name="chargerid" placeholder="담당자 추가" autocomplete="off" onkeyup="search(this);"> 
                     ...
                     <div class="workTab">
                        <label><img src="/img/calendar.png" class="imgjyh" > </label>   
                           <input type="text" class="datepicker" autocomplete="off" id="stdate" name="jobbgnde" placeholder="시작일시 추가">    
                        </div>
                     <br>
                     <hr>
                           <div class="workTab">
                        <label><img src="../img/calendar2.png" class="imgjyh" > </label>   
                        <input type="text" class="datepicker" id="eddate" name="jobclosde" autocomplete="off" placeholder="마감일시 추가" > 
                     ...
                     <hr>
                        ...
                        <input type="text" id="importance" name="jobpriort" placeholder="우선순위 선택" autocomplete="off"> 
...
<!--                      </div> -->
               ...
               <textarea class="textarea textarea_h" name="jobcn" rows="6" placeholder="업무내용을 입력하세요 ✍"></textarea>
               </div>
               <br>
...
<!--                파일 -->
             	 ...
             	 <input type='file'  id='file_upload' onchange="getCmaFileView(this)" multiple />
					<label for='file_upload'><i class="far fa-file-image"></i>파일 선택</label>
               	</div>
               	
               	
               <hr>
                  <input class="btn btn-light pull-right" type="submit" style="background: orange;" value="등록"/>
               <br>
               <br>
...
<!--             일정  -->
          ...
          <div id="insertcalendar" style="display: none;">
               ...
               <hr>
                 ...
                 <label>시작일</label>
                 <input type="text" class="datepicker_wstart" id="stdate_wstart" style="width:150px; text-align: center;" >
              	 &nbsp;&nbsp;&nbsp;~ &nbsp;&nbsp;
              	 <label style="">종료일</label>  
                 <input type="text" class="datepicker_wend" id="stdate_wend" style="width:150px; text-align: center;" >
          
                <hr>
                
                <div style="postion:relative;" id="sendmember">  
					 <label>참석자</label>
					<input type="text" id="word" name="find_usid" style="width: 100px;"
...
// 				foreach function(i,v)를 사용해서 html div안에 계속 div(일정게시글)가 생성 되도록 한다  
					location.href="/project/selectallproject";
					alert("일정 등록 성공");
					},
			error : function(xhr){
				alert("일정 등록 실패");
...
function getCmaFileView(obj) {
    ...
    var list= "<div class='filelist' id='"+allfilename+"'><span>"+allfilename+"</span><input type='button' value='삭제' class='filedebutton' data-filenm='"+allfilename+"' onclick='delClick()'></input></div><br>";
    
    if(extName=="zip"||extName=="txt"||extName=="jpg"||extName=="png"||extName=="JPG"||extName=="PNG"){
    	$(".preview").append(list);
    }        
//     else if(extName=="txt"){
//     	$(".preview").append(list);
