...
<body>
<%@ include file="/WEB-INF/views/common/KDYheader.jsp" %>
<div class="wrapper">
	...
	<section class="content">
		<header class="main-header clearfix">
			...
			<a href="/project/recyclebin" class="btn btn-light" ><i class="pe-7f-trash" style="font-size: 30px;"></i></a>
		</header>
				...
				<form action="/project/completepro" id="frm">
					...
					<article class="widget"<c:choose>
						...
						시작일&emsp;:&emsp;<fmt:formatDate value="${pro.prjctcreatde}" pattern="yyyy-MM-dd"/> 
							...
							<br>
	                   	종료일&emsp;:&emsp;<span id="officialProject" class="official-project">${pro.prjctcn }</span>
	...
	<div class="modal fade" style="display:inline-block;" id="modalgo"
		...
		<div class="align_center">
		        ...
		        <form action="/invite/inviteinsert">
			        <c:forEach items="${invitelist2}" var="list">
				        <span>&emsp;&emsp;&emsp;프로젝트제목: ${list.prjctnm }</span><hr>
				        <span>&emsp;&emsp;&emsp;프로젝트번호:${prjctno} </span><hr>
				        <span>&emsp;&emsp;&emsp;${usernm } 님이 프로젝트에 초대합니다</span><hr>
			        </c:forEach>
		        
		   
	
				<div class="modal-footer" style="background:cadetblue; padding: 8px;">
					<button type="button" class="btn btn-secondary" style="background: #333333;"
						data-dismiss="modal">거절</button>
					<button type="submit" id="sendajax" style="background: #333333;" class="btn btn-secondary">수락</button>
    	</div>
		        </form>
