...
var count=2;
	function insRow() {
		...
		//삽입될 Form Tag
		var frmTag = "<br>"+count+".<input type=text name=votelist placeholder='보기를 입력하세요' style=width:340px; height:20px;> ";
											...
											<tr>
												<td height="25">
													<table id="addTable" width="400" cellspacing="0"
														...
														<tr>
															<br>
															<td>1. <input type="text" name="votelist"
				...
				<article class="widget">
					...
					<div class="widget__content">
						...
						<div style="text-align: center;">
							...
							<ul class="pagination" >
									 <li class="prev"><a href="/vote/votemake?page=1&pageSize=${pageVo.getPageSize()}">«</a>
									</li> 
									 <li class="prev"><a href="/vote/votemake?page=${pageVo.getPage() - 1 }&pageSize=${pageVo.getPageSize()}">＜</a>
									</li> 
									...
									<c:forEach begin="1" end="${pagination }" var="i">
										...
										<c:choose>
											...
											<c:otherwise>
												<li><a
													href="/vote/votemake?page=${i }&pageSize=${pageVo.getPageSize()}">${i }</a></li>
											</c:otherwise>
									...
									<li class="next"><a
										href="/vote/votemake?page=${pageVo.getPage() + 1 }&pageSize=${pageVo.getPageSize()}">＞</a>
									</li> 
									<li class="next"><a
										href="/vote/votemake?page=${pagination}&pageSize=${pageVo.getPageSize()}">»</a>
									</li> 
								</ul>
				</div>
				</article>
