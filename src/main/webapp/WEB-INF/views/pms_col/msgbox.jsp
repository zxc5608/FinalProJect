		...
		$(".board").on("click", function() {
			...
			$.ajax({
				...
				success : function(rs){
					...
					$('#msgusid').text(rs.msgvo.usid);
					$('#msgdate').text(rs.msgvo.mssagede);	
					
					$('#balusid').val(rs.msgvo.usid);
...
<body>
		...
		<section class="content">
			<header class="main-header clearfix">
				...
				<div class="btn-group" style="">
							<button type="button" class="btn btn-default" onclick="location.href='/msg/msgAllList'" style="background: gainsboro;">수신함</button>
			...
			<article class="widget">
				<header class="widget__header">
					<h3 class="widget__title" style="color:red;">읽지 않은 메시지함</h3>
								...
								<c:when test="${empty msgList}">
									<tr>
										<td colspan="4" align="center">
											<p style="text-align: center; font-size: 20px;">새로운 메세지가 없습니다.</p>
										</td>
			...
			<article class="widget" id="fresh">
				<header class="widget__header">
					<h3 class="widget__title" style="color: black;">읽은 메시지함</h3>
					<div class="widget__config">
				...
				<div class="widget__content">
					<table class="table">
						...
						<tbody>
							<c:forEach items="${msgList2 }" var="msg1">
								<tr class="board" data-mno="${msg1.mssageno}"
									data-re_usid="${msg1.re_usid}" data-cont="${msg1.mssagecn}">
									<td>${msg1.mssageno2}</td>
									<td>${msg1.mssagesj}</td>
									<td>${msg1.usid}</td>
									<td>${msg1.mssagede}</td>
								</tr>
				...
				<div style="text-align: center;">
							...
							<ul class="pagination" >
									 <li class="prev"><a href="/msg/msgAllList?page=1&pageSize=${pageVo.getPageSize()}">«</a>
									</li> 
									 <li class="prev"><a href="/msg/msgAllList?page=${pageVo.getPage() - 1 }&pageSize=${pageVo.getPageSize()}">＜</a>
									</li> 
									...
									<c:forEach begin="1" end="${pagination }" var="i">
										...
										<c:choose>
											...
											<c:otherwise>
												<li><a
													href="/msg/msgAllList?page=${i }&pageSize=${pageVo.getPageSize()}">${i }</a></li>
											</c:otherwise>
									...
									<li class="next"><a
										href="/msg/msgAllList?page=${pageVo.getPage() + 1 }&pageSize=${pageVo.getPageSize()}">＞</a>
									</li> 
									<li class="next"><a
										href="/msg/msgAllList?page=${pagination}&pageSize=${pageVo.getPageSize()}">»</a>
									</li> 
								</ul>
				</div>
			</article>
	...
	<div class="modal fade" style="display:" id="Detailmodal" tabindex="-1"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content" style="font-weight: 800;">
				...
				<div class="modal-body">
						...
						<div class="form-group row">
							...
							<div class="col-sm-9 input-group-sm">
								<label id="msgcont" style="border: 1px solid black; height: 50px; width: 300px;" ></label>
							</div>
						</div>
						<div class="form-group row">
							<label for="id" class="col-sm-3" style="font-size: 0.9em;">
							...
							<div class="col-sm-9 input-group-sm" id="usid2">
								<label id="msgusid"></label>
							</div>
						</div>
						<div class="form-group row">
							<label for="id" class="col-sm-3" style="font-size: 0.9em;">
	...
	<div class="modal fade" style="display:" id="replymodal" tabindex="-1"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLongTitle">답장하기 </h5>

				</div>
				<form action="/msg/replysend">
				<div class="modal-body">
				<strong>수신자:</strong> &emsp;<input type="text" name="re_usid" id="balusid" /> <br><br>
