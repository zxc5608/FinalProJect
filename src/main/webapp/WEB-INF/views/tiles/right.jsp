...
$(function(){
	...
	$("#chatBt").on('click', function(){
		window.open("<%=request.getContextPath()%>/socket/view", "chat", "width=640, height=460")
	})
...
<body>
      ...
      <aside class="sidebar_r">
			...
			<button class="btn btn-grey btn-block" style="height:60px; background: cadetblue;" data-toggle="modal" data-target="#inviteMail" id="maileeeee"><img src="/icon/plus.png" >&nbsp;&nbsp;초대하기</button>
