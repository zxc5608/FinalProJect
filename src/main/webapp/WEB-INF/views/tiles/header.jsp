	...
	$('#sendajax').click(function(e){
		...
		$.ajax({
			...
			data:{
				...
				"mssagecn":$('textarea[name="mssagecn"]').val()
			},
			success:function(result){
	...
	<header class="top-bar">
		...
		<ul class="profile">
			...
			<li class="profile--higlighted1"><span
				class="badge profile__badge badge--red" id="cnt"></span> 
				...
				<ul class="dropdown-menu pull-right">
					<li><a style="color: white; width:200px;">
						<button style="background: azura; color: black;" type="button" data-toggle="modal" data-target="#exampleModalLong">메시지 작성하기💌</button></a></li>
					<li><a href="/msg/msgAllList"><i class="icon pe-7s-mail" style="margin-left:35px; color:white;"></i>메세지함</a></li>
				</ul>
			</li>
			...
			<li>
				...
				<ul class="dropdown-menu pull-right">
					<li><a href="/user/jmypage"><i class="icon pe-7s-info"></i> My Page </a></li>
					<li><a href="/user/jlogout"><i class="icon pe-7s-close-circle"></i> Log Out</a></li>
				</ul>
			</li>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body" style="margin:10px;">
					...
					제목 &emsp;:&emsp;<input type="text" name="mssagesj" id="mssagesj" /><br>
					<br><br>
					내용 &emsp;:&emsp;<textarea rows="5" cols="30" name="mssagecn" id="mssagecn"></textarea>
